...
for username in namelist:
    ...
    with open(username_path, "r", encoding="UTF-8") as f:
        ...
        for row_content in res:
            ...
            </tr>""".format(number = counter, tweet_time = row_content[8], tweet_information = highlight_content, retweet_count = row_content[5], favorite_count = row_content[6], twitter_url = row_content[4], user_name=row_content[1])
                counter += 1
